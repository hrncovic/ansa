...
EXECUTE_ON_STARTUP(
    ...
    e->insert(IGMP_MEMBERSHIP_REPORT_V1, "IGMP_MEMBERSHIP_REPORT_V1");
    e->insert(IGMP_MEMBERSHIP_REPORT_V2, "IGMP_MEMBERSHIP_REPORT_V2");
    e->insert(IGMP_LEAVE_GROUP, "IGMP_LEAVE_GROUP");
);
...
short IGMPMessage::getType() const
{
    return type_var;
}

void IGMPMessage::setType(short type)
{
    this->type_var = type;
}

short IGMPMessage::getMaxRespTime() const
{
    return maxRespTime_var;
}

void IGMPMessage::setMaxRespTime(short maxRespTime)
{
    this->maxRespTime_var = maxRespTime;
}

IPAddress& IGMPMessage::getGroupAddress()
{
    return groupAddress_var;
}

void IGMPMessage::setGroupAddress(const IPAddress& groupAddress)
{
